...
### Fixed
- Correct GitHub repository URLs in README badges and demo GIF references.

## [1.0.3] - 2026-04-10

### Fixed
- Center the built-in settings icon consistently inside the inner gauge circle across sizes.

## [1.0.2] - 2026-04-10

### Fixed
- Render alert thresholds as outer gauge bands instead of center-filled slices.
- Make the native settings affordance visible and populate configured fields correctly.
- Add `select` support and `disableEditButton` parity to the built-in settings API.
